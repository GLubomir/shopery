...
$bottom_classes = 'header__bottom';
$bottom_box_classes = 'header__bottom-box';
$nav_class = 'header__nav';
$list_class = 'header__list';
$numbers_class = 'header__numbers';

if ( $is_mobile ) {
	$bottom_classes .= ' header__bottom--drawer';
	$bottom_box_classes .= ' header__bottom-box--drawer';
	$nav_class .= ' header__nav--drawer';
	$list_class .= ' header__list--drawer';
	$numbers_class .= ' header__numbers--drawer';
}
?>

<div class="<?php echo esc_attr( $bottom_classes );?>">
	<div class="container">
		<div class="<?php echo esc_attr( $bottom_box_classes );?>">
			<?php
			wp_nav_menu(
				[
					...
					'container_aria_label' => esc_attr__( 'Головне меню', 'shopery' ),
					'menu_class' => $list_class,
				]
			);
			?>
			<a class="<?php echo esc_attr( $numbers_class );?>" href="tel:2195550114" aria-label="<?php esc_attr_e( 'Зателефонувати за номером (219) 555-0114', 'shopery' );?>">
				...
				<span class="header__number-text">(219) 555-0114</span>
			</a>
		</div>
	</div>
</div>